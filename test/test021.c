...
#define spike00_core1(r, s) \
  ...
  mo4(OP_LDRQ,  1,  BR[r][1],      (Ull)a[s][CHIP],   (Ull)cofs,   MSK_W1,    (Ull)a[s][CHIP],  L,         0,      0,   (Ull)NULL,   L);         /* stage#2 IMXlen¤¬Âç¤­¤¤¤Î¤ÇLMM*2»ÈÍÑ */\
  exe(OP_NOP,      &AR[r][0], 0LL, EXP_H3210,         0LL,         EXP_H3210, 0LL,              EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL);            /* stage#2 (dummy to set target location) */\
  mop(OP_LDWR,  1, &b00,           (Ull)c0[s][CHIP],  (Ull)oofs,   MSK_W0,    (Ull)c[s][CHIP],  W*RMGRP,   0,      1,   (Ull)NULL,   W*RMGRP);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
  mop(OP_LDWR,  1, &b01,           (Ull)c1[s][CHIP],  (Ull)oofs,   MSK_W0,    (Ull)c[s][CHIP],  W*RMGRP,   0,      1,   (Ull)NULL,   W*RMGRP);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
  mop(OP_LDWR,  1, &b02,           (Ull)c2[s][CHIP],  (Ull)oofs,   MSK_W0,    (Ull)c[s][CHIP],  W*RMGRP,   0,      1,   (Ull)NULL,   W*RMGRP);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
  mop(OP_LDWR,  1, &b03,           (Ull)c3[s][CHIP],  (Ull)oofs,   MSK_W0,    (Ull)c[s][CHIP],  W*RMGRP,   0,      1,   (Ull)NULL,   W*RMGRP);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
...
#define spike01_core1(r, s) \
  ...
  mo4(OP_LDRQ,  1,  BR[r][1], (Ull)a[s][CHIP],          (Ull)cofs,        MSK_W1,    (Ull)a[s][CHIP], L,         0,      0,   (Ull)NULL,   L);       /* stage#2 IMXlen¤¬Âç¤­¤¤¤Î¤ÇLMM*2»ÈÍÑ */\
  exe(OP_NOP,      &AR[r][0], 0LL,           EXP_H3210, 0LL,              EXP_H3210, 0LL,             EXP_H3210, OP_NOP, 0LL, OP_NOP,      0LL);     /* stage#2 (dummy to set target location) */\
  mop(OP_LDWR,  1, &b00,      (Ull)c0[s][CHIP],         (Ull)oofs,        MSK_W0,    (Ull)c[s][CHIP], RMGRP,     0,      1,   (Ull)NULL,   RMGRP);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
...
#define spike02_core1(r, s) \
  ...
  mo4(OP_LDRQ,  1,  BR[r][1], (Ull)a[s][CHIP],          (Ull)cofs,        MSK_W1,    (Ull)a[s][CHIP], L/4,       0,      0,    (Ull)NULL,   L/4);       /* stage#2 IMXlen¤¬Âç¤­¤¤¤Î¤ÇLMM*2»ÈÍÑ */\
  exe(OP_NOP,      &AR[r][0], 0LL,           EXP_H3210, 0LL,              EXP_H3210, 0LL,             EXP_H3210, OP_NOP, 0LL,  OP_NOP,      0LL);       /* stage#2 (dummy to set target location) */\
  mop(OP_LDBR,  1, &b00,      (Ull)c0[s][CHIP],         (Ull)oofs,        MSK_W0,    (Ull)c[s][CHIP], RMGRP/4,   0,      1,    (Ull)NULL,   RMGRP/4);   /* stage#2 fold¤Ïunit[0]¤ËÍ×»ØÄê */\
