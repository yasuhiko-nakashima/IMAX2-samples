...
gather_x1(Uint *yin, Uint *yout)
{
  ...
  /* EMAX5                                       */
  /***********************************************/
  Ull  yin_mm0 = yin-image_WD-2;
  Ull  yin_mm1 = yin-image_WD-4;
  Ull  yin_m0  = yin-image_WD;
  Ull  yin_m1  = yin-image_WD-2;
  Ull  yin_mp0 = yin-image_WD+2;
  Ull  yin_mp1 = yin-image_WD+0;
  ...
  Ull  yin_pm0 = yin+image_WD-2;
  Ull  yin_pm1 = yin+image_WD-4;
  Ull  yin_p0  = yin+image_WD;
  Ull  yin_p1  = yin+image_WD-2;
  Ull  yin_pp0 = yin+image_WD+2;
  Ull  yin_pp1 = yin+image_WD+0;

  Ull  yin_q0  = yin+image_WD*2;
  Ull  yin_q1  = yin+image_WD*2-2;
...
//EMAX5A begin x1 mapdist=0
  while (loop--) {                                                   /* mapped to WHILE() on BR[15][0][0] stage#0 */
    ...
    mop(OP_LDR,  3, &BR[1][0][1],  (Ull)yin_mm0, x, MSK_D0, (Ull)yin_m0, 320, 0, 0, (Ull)yin_z0, 320);      /* stage#1 */
    mop(OP_LDR,  3, &BR[1][1][1],  (Ull)yin_mp0, x, MSK_D0, (Ull)yin_m0, 320, 0, 0, (Ull)yin_z0, 320);      /* stage#1 */
    mop(OP_LDR,  3, &BR[1][2][1],  (Ull)yin_mm1, x, MSK_D0, (Ull)yin_m1, 320, 0, 0, (Ull)yin_z1, 320);      /* stage#1 */
    mop(OP_LDR,  3, &BR[1][3][1],  (Ull)yin_mp1, x, MSK_D0, (Ull)yin_m1, 320, 0, 0, (Ull)yin_z1, 320);      /* stage#1 */
    mop(OP_LDR,  3, &BR[2][0][1],  (Ull)yin_zm0, x, MSK_D0, (Ull)yin_z0, 320, 0, 0, (Ull)yin_p0, 320);      /* stage#2 */
    mop(OP_LDR,  3, &BR[2][1][1],  (Ull)yin_zp0, x, MSK_D0, (Ull)yin_z0, 320, 0, 0, (Ull)yin_p0, 320);      /* stage#2 */
    mop(OP_LDR,  3, &BR[2][2][1],  (Ull)yin_zm1, x, MSK_D0, (Ull)yin_z1, 320, 0, 0, (Ull)yin_p1, 320);      /* stage#2 */
    mop(OP_LDR,  3, &BR[2][3][1],  (Ull)yin_zp1, x, MSK_D0, (Ull)yin_z1, 320, 0, 0, (Ull)yin_p1, 320);      /* stage#2 */
    mop(OP_LDR,  3, &BR[3][0][1],  (Ull)yin_pm0, x, MSK_D0, (Ull)yin_p0, 320, 0, 0, (Ull)yin_q0, 320);      /* stage#3 */
    mop(OP_LDR,  3, &BR[3][1][1],  (Ull)yin_pp0, x, MSK_D0, (Ull)yin_p0, 320, 0, 0, (Ull)yin_q0, 320);      /* stage#3 */
    mop(OP_LDR,  3, &BR[3][2][1],  (Ull)yin_pm1, x, MSK_D0, (Ull)yin_p1, 320, 0, 0, (Ull)yin_q1, 320);      /* stage#3 */
    mop(OP_LDR,  3, &BR[3][3][1],  (Ull)yin_pp1, x, MSK_D0, (Ull)yin_p1, 320, 0, 0, (Ull)yin_q1, 320);      /* stage#3 */
    exe(OP_ADD3, &r10, BR[1][0][1], EXP_H3210,  BR[2][0][1], EXP_H3210,  BR[3][0][1], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#4 */
    exe(OP_ADD3, &r11, BR[1][1][1], EXP_H3210,  BR[2][1][1], EXP_H3210,  BR[3][1][1], EXP_H3210, OP_NOP, 0LL, OP_NOP, 0LL); /* stage#4 */
