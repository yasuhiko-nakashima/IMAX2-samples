...
//EMAX5A begin x1 mapdist=1
  while (loop--) {                                                   /* mapped to WHILE() on BR[15][0][0] stage#0 */
    ...
    mop(OP_LDR,  3, &BR[1][0][1],  (Ull)yin_mm0, x, MSK_D0, (Ull)yin_m0, 320, 0, 0, (Ull)NULL, 320);        /* stage#1 */
    mop(OP_LDR,  3, &BR[1][1][1],  (Ull)yin_mp0, x, MSK_D0, (Ull)yin_m0, 320, 0, 0, (Ull)NULL, 320);        /* stage#1 */
    mop(OP_LDR,  3, &BR[1][2][1],  (Ull)yin_mm1, x, MSK_D0, (Ull)yin_m1, 320, 0, 0, (Ull)NULL, 320);        /* stage#1 */
    mop(OP_LDR,  3, &BR[1][3][1],  (Ull)yin_mp1, x, MSK_D0, (Ull)yin_m1, 320, 0, 0, (Ull)NULL, 320);        /* stage#1 */
    mop(OP_LDR,  3, &BR[2][0][1],  (Ull)yin_zm0, x, MSK_D0, (Ull)yin_z0, 320, 0, 0, (Ull)NULL, 320);        /* stage#2 */
    mop(OP_LDR,  3, &BR[2][1][1],  (Ull)yin_zp0, x, MSK_D0, (Ull)yin_z0, 320, 0, 0, (Ull)NULL, 320);        /* stage#2 */
    mop(OP_LDR,  3, &BR[2][2][1],  (Ull)yin_zm1, x, MSK_D0, (Ull)yin_z1, 320, 0, 0, (Ull)NULL, 320);        /* stage#2 */
    mop(OP_LDR,  3, &BR[2][3][1],  (Ull)yin_zp1, x, MSK_D0, (Ull)yin_z1, 320, 0, 0, (Ull)NULL, 320);        /* stage#2 */
